                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text('Novo Horário',
                                    style: TextStyle(color: corTexto, fontSize: 24, fontWeight: FontWeight.bold)),
                                Text('Selecione o horário desejado',
                                    style: TextStyle(color: corTexto.withOpacity(0.7), fontSize: 13)),
                              ],
                            ),
                          ),
                        ],
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Icon(Icons.access_time_rounded, color: corTexto, size: 48),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Icon(Icons.touch_app, size: 14, color: corTexto),
                                        const SizedBox(width: 6),
                                        Text('Toque para alterar',
                                            style: TextStyle(color: corTexto, fontSize: 12, fontWeight: FontWeight.w500)),
                                      ],
                                    ),
                                  ),
                                ],
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      final endMinutes = selectedTime.hour * 60 + selectedTime.minute + duration;
                                      ...
                                      _loadSlotsForDate();
                                      _showSuccessSnackBar('Horário $startTime adicionado!');
                                    } catch (e) {
                                      _showErrorSnackBar('Erro ao adicionar horário: $e');
                                    }
                                  },
                                ),
                              ),
              ...
              content: Column(
                ...
                children: [
                  Container(
                    ...
                    child: ListTile(
                      title: Text('Início', style: TextStyle(color: corTexto.withOpacity(0.7))),
                  ...
                  Container(
                    ...
                    child: ListTile(
                      title: Text('Fim', style: TextStyle(color: corTexto.withOpacity(0.7))),
      ...
      body: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: corPrimaria.withOpacity(0.3)),
            child: Row(
                    ...
                    child: Column(
                      children: [
                        Text(selectedDate.day.toString(),
                            style: TextStyle(color: corTexto, fontSize: 36, fontWeight: FontWeight.bold)),
                        Text(_getMonthName(selectedDate.month), style: TextStyle(color: corTexto, fontSize: 16)),
                        Text(_getWeekdayName(selectedDate.weekday),
                            style: TextStyle(color: corTexto.withOpacity(0.6), fontSize: 14)),
                      ],
                    ),
                  ),
                ),
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('Gerar', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            child: isLoading
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('Carregando horários...', style: TextStyle(color: corTexto.withOpacity(0.6))),
                ],
              ),
            )
                : timeSlots.isEmpty
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.access_time, size: 80, color: corTexto.withOpacity(0.5)),
                  ),
                  const SizedBox(height: 20),
                  Text('Nenhum horário cadastrado',
                      style: TextStyle(color: corTexto.withOpacity(0.6), fontSize: 18)),
                  const SizedBox(height: 10),
                  TextButton.icon(
                    onPressed: _showGenerateDialog,
                    icon: const Icon(Icons.auto_awesome),
                    label: const Text('Gerar horários automaticamente'),
                    style: TextButton.styleFrom(
                      foregroundColor: corTexto,
              ...
              itemBuilder: (context, index) {
                ...
                return Stack(
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        color: slot.isBooked ? Colors.grey[400] : corPrimaria,
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: corTexto.withOpacity(0.3), width: 2),
                        boxShadow: [
                          BoxShadow(
                            color: corPrimaria.withOpacity(0.3),
                            blurRadius: 8,
                            ...
                            onTap: () {
                              showDialog(
                                ...
                                builder: (ctx) => AlertDialog(
                                  ...
                                  title: Text('Remover ${slot.startTime}?', style: TextStyle(color: corTexto)),
